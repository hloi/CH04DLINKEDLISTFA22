...
#ifndef CH04DLINKEDLISTFA22_LIST_ITERATOR_H
#define CH04DLINKEDLISTFA22_LIST_ITERATOR_H
...
/** A modified version of this iterator that
    now references the next position
    @throws std::invalid_argument If this iterator is at begin
    */
    iterator& operator++() {
        if (current == NULL)
...
#endif //CH04DLINKEDLISTFA22_LIST_ITERATOR_H
